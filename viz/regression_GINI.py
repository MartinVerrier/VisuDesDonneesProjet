...
# Chargez les données
data = pd.read_csv("/home/martin/Bureau/Cours/INFO5/VisuDonnées/Projet/VisuDesDonneesProjet/data/income_gini.tsv", sep='\t')
...
new_data = pd.DataFrame(columns=["country", "year", "gini_index", "is_estimate"])
...
for country in data["country"].unique():
    ...
    for year in range(1914, 2018):
        ...
        if data.query("year == @year and country == @country").empty == True :
            ...
            new_data = new_data.append(pd.DataFrame({"country": country, "year": year, "gini_index": gini_pred, "is_estimate": True}, index=[0]), ignore_index=False)
...
data.to_csv("/home/martin/Bureau/Cours/INFO5/VisuDonnées/Projet/VisuDesDonneesProjet/data/new_income_gini.tsv", sep='\t')